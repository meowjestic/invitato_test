<template>
  ...
  "isSnap": true
        ...
        <div class="hs-carousel w-full flex snap-x snap-mandatory !overflow-hidden bg-white rounded-lg">
            <div class="hs-carousel-body min-h-72 flex flex-nowrap gap-2 transition-transform duration-700 opacity-0">
